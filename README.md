...
[1.1 Назначение](https://github.com/Gleb647/tritpo2/blob/master/README.md#11-назначение)<br>
[1.2 Бизнес требования](https://github.com/Gleb647/tritpo2/blob/master/README.md#12-бизнес-требования)<br>
[1.2.1 Исходные данные](https://github.com/Gleb647/tritpo2/blob/master/README.md#121-исходные-данные)<br>
[1.2.2 Возможности бизнеса](https://github.com/Gleb647/tritpo2/blob/master/README.md#122-возможности-бизнеса)<br>
[1.2.3 Границы проекта](https://github.com/Gleb647/tritpo2/blob/master/README.md#123-границы-проекта)<br>
[1.3 Аналоги](https://github.com/Gleb647/tritpo2/blob/master/README.md#13-аналоги)<br>
[2 Требования к пользовательскому интерфейсу](https://github.com/Gleb647/tritpo2/blob/master/README.md#2-требования-к-пользовательскому-интерфейсу)<br>
[2.1 Интерфейс пользователя](https://github.com/Gleb647/tritpo2/blob/master/README.md#21-интерфейс-пользователя)<br>
[2.2 Классы пользователей](https://github.com/Gleb647/tritpo2/blob/master/README.md#22-классы-пользователей)<br>
[3 Системные требования](https://github.com/Gleb647/tritpo2/blob/master/README.md#3-системные-требования)<br>
[3.1 Функциональные требования](https://github.com/Gleb647/tritpo2/blob/master/README.md#31-функциональные-требования)<br>
[3.1.1 Вход пользователя в приложение](https://github.com/Gleb647/tritpo2/blob/master/README.md#311-вход-пользователя-в-приложение)<br>
[3.1.2 Создание игровой комнаты](https://github.com/Gleb647/tritpo2/blob/master/README.md#312-создание-игровой-комнаты)<br>
[3.1.3 Поиск игровой комнаты](https://github.com/Gleb647/tritpo2/blob/master/README.md#313-поиск-игровой-комнаты)<br>
[3.1.4 Просмотр игровой статистики](https://github.com/Gleb647/tritpo2/blob/master/README.md#314-просмотр-игровой-статистики)<br>
[3.1.5 Наличие чата в главном окне приложения](https://github.com/Gleb647/tritpo2/blob/master/README.md#315-наличие-чата-в-главном-окне-приложения)<br>
[3.2 Нефункциональные требования](https://github.com/Gleb647/tritpo2/blob/master/README.md#32-нефункциональные-требования)<br>
[3.2.1 Атрибуты качества](https://github.com/Gleb647/tritpo2/blob/master/README.md#321-атрибуты-качества)<br>
[3.2.1.1 Требования к удобству использования](https://github.com/Gleb647/tritpo2/blob/master/README.md#3211-требования-к-удобству-использования)<br>
[3.2.1.2 Требования к безопасности](https://github.com/Gleb647/tritpo2/blob/master/README.md#3212-требования-к-безопасности)<br>
[3.2.2 Внешние интерфейсы](https://github.com/Gleb647/tritpo2/blob/master/README.md#322-внешние-интерфейсы)<br>
[3.2.3 Ограничения](https://github.com/Gleb647/tritpo2/blob/master/README.md#323-ограничения)<br>
...
Uno - карточная настольная игра, целью которой является избавление от всех карт. Победитель получает очки, согласно картам, оставшимся на руках у остальных. Игроки в Уно за свой ход скидывают по одной карте таким образом, чтобы скидываемая совпадала по цвету или номиналу с картой, сброшенной предыдущим игроком. На сегодняшний день в мире более 150 000 000 людей успели купить Uno. За более чем 50 лет существования свою популярность игра обрела относительно недавно, в связи с чем появился спрос на её разработку для онлайн-платформ с настольными играми. 

## 1.2.2 Возможности бизнеса

Заинтересованные в настольных играх молодые люди хотели бы иметь онлайн-доступ к любимой игре, а также быстро находить компанию для игры.

## 1.2.3 Границы проекта

Приложение "Uno online" не разделяет зарегистрированных и анонимных пользователей по основным функциональным возможностям, а именно: создание игровой комнаты и присоединение к ней, пользование игровым чатом. Помимо основного функционала для зарегистрированных пользователей будет доступен магазин для изменения частей пользовательского интерфейса: карт для игры, иконки профиля. 

## 1.3 Аналоги

Самым популярным из отечественных аналогов является игра "Свинтус", в которую можно сыграть онлайн на площадке boardgamearena. Однако для доступа к играм и созданию игровых комнат пользователю необходимо зарегестрироваться, что, безусловно, является отталкивающим фактором для выбора платформы новыми игроками. Среди плюсов можно выделить:
...
| Функция | Требования | 
|:---|:---|
| Отправка сообщений | Длина сообщения должна быть ограничена. В приложении также должна быть возможность отправки эмодзи |
